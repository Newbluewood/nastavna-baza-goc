...
async function seedNews(connection, shouldExecute) {
  const newsItems = [
    ...
    ['Печењара поново ради', 'Обновљен павиљон печењаре — спреман за нову сезону.', 'Након темељне реконструкције, павиљон печењаре је поново отворен за госте и посетиоце. Нови роштиљ и проширен простор за седење омогућавају пријем већих група. Домаћа телетина испод сача остаје наша специјалност.', placeholder, 'pecenjara-ponovo-radi'],
    ['Мастер рад — нови објекат уз печењару', 'Студенткиња Шумарског факултета израђује пројекат новог објекта уз постојећу печењару.', 'Пројекат је у фази разраде и обухвата техничке цртеже, планове извођења и студију уклапања у постојећи амбијент базе. Нови објекат планирано је да буде изграђен непосредно уз печењару и служиће за додатне смештајно-услужне капацитете. Рад ће бити одбрањен у јунском одбрамбеном року.', placeholder, 'master-rad-novi-objekat'],
