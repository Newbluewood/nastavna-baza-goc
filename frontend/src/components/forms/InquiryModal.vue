    ...
    <div class="modal-content">
      ...
      <template v-else>
        ...
        <form @submit.prevent="submitForm" class="inquiry-form">
          ...
          <div class="form-group">
            <label>{{ langStore.t('inquiry.boardType') }}</label>
            <select v-model="form.board_type" class="board-select">
              <option value="base">{{ langStore.t('inquiry.boardBase') }}</option>
              <option value="half">{{ langStore.t('inquiry.boardHalf') }}</option>
              <option value="full">{{ langStore.t('inquiry.boardFull') }}</option>
            </select>
          </div>
